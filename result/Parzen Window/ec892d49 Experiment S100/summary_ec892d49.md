...
|-------|--------|--------|-----------|----------|--------|--------|
| Model | 0.9206 | 0.0102 | 0.9707    | 603.0993 | 1.1245 | 0.9216 |
                                                                    
## Plot Prediction

<img src="pdf_ec892d49.png">
...
| KEY | VALUE               |
|-----|---------------------|
| h   | 0.09795517178517492 |
                             
</details>

<details><summary>Model Architecture </summary>

ParzenWindow_Model(h=0.09795517178517492, training=array([1.40171379, 0.16787657, 0.87159631, 1.87457757, 0.62793651,
