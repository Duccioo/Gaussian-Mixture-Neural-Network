...
|-------|--------|-------|-----------|----------|-------|--------|
| Model | 0.9247 | 0.012 | 0.8547    | 300.9994 | 0.702 | 0.9263 |
                                                                  
## Plot Prediction

<img src="pdf_2bc875cd.png">
...
| KEY | VALUE              |
|-----|--------------------|
| h   | 0.1115631857896388 |
                            
</details>

<details><summary>Model Architecture </summary>

ParzenWindow_Model(h=0.1115631857896388, training=array([1.40171379, 0.16787657, 0.87159631, 1.87457757, 0.62793651,
