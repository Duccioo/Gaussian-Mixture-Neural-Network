...
|-------|--------|--------|-----------|----------|-------|--------|
| Model | 0.5696 | 0.0688 | 1.1681    | 215.9923 | 0.702 | 0.5791 |
                                                                   
## Plot Prediction

<img src="pdf_0319dd0d.png">
...
KNN_Model(k1=7.255122108569863, kn=72, training=array([1.40171379, 0.16787657, 0.87159631, 1.87457757, 0.62793651,
